...
def get_available_cameras():
    ...
    # Hardcoded camera detection for macOS with virtual camera
    camera_indices = [0]  # We know index 0 is detected from our test
    camera_names = ["Virtual Camera"]

    print("Using hardcoded camera detection for macOS with virtual camera")
    print(f"Detected cameras: {camera_indices}, {camera_names}")
